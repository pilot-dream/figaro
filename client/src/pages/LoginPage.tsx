...
export function LoginPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-10 px-4">
      <GlassCard glow className="w-full max-w-md p-8 space-y-6 border-[#D4AF37] shadow-2xl relative overflow-hidden bg-gradient-to-br from-[#1a1c23] to-[#0A0E14]">
        {/* Ambient glow */}
        <div className="absolute -top-16 -right-16 w-36 h-36 bg-[#D4AF37] rounded-full blur-3xl pointer-events-none" />

        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#FBE7A1] to-[#D4AF37] border border-[#D4AF37] flex items-center justify-center mx-auto shadow-lg shadow-[#D4AF37]/30">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-[#D4AF37] focus:bg-white/10 transition-colors"
              />
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-4 text-center">
          <p className="text-xs text-figaro-text-secondary">
            ...
            <Link
              ...
              className="text-[#D4AF37] font-bold hover:text-[#D4AF37] hover:underline transition-colors"
            >
              Criar Conta Rápida
            </Link>
          </p>
