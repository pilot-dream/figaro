      ...
      <div className="relative w-full max-w-md bg-[#0A0E14]/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_16px_40px_rgba(0,0,0,0.6)] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="px-6 py-4 border-b border-white/5 flex items-center justify-between">
          <h2 className="text-lg font-bold text-white flex items-center gap-2">
            <Building2 className="w-5 h-5 text-[#11AFFA]" />
            Nova Filial
          </h2>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-2.5 pl-10 pr-3 text-white placeholder-white/20 focus:outline-none focus:border-[#11AFFA]/50 focus:ring-1 focus:ring-[#11AFFA]/50 transition-all text-sm"
                  value={formData.name}
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg py-2.5 px-3 text-white placeholder-white/20 focus:outline-none focus:border-[#11AFFA]/50 focus:ring-1 focus:ring-[#11AFFA]/50 transition-all text-sm"
                ...
                <div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-lg py-2 pl-10 pr-3 text-white placeholder-white/20 focus:outline-none focus:border-[#11AFFA]/50 focus:ring-1 focus:ring-[#11AFFA]/50 transition-all text-sm"
          ...
          <div className="pt-4 flex gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-2.5 rounded-lg bg-[#11AFFA] text-black font-semibold hover:bg-[#11AFFA]/90 hover:shadow-[0_0_15px_rgba(17,175,250,0.3)] transition-all text-sm disabled:opacity-50"
            >
