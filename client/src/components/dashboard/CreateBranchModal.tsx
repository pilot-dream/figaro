...
export function CreateBranchModal({ isOpen, onClose, onSubmit, loading }: CreateBranchModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div 
        className="absolute inset-0 bg-figaro-black/80 backdrop-blur-sm transition-opacity"
        onClick={onClose}
      />
      
      <div className="relative w-full max-w-md bg-figaro-black/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_16px_40px_rgba(0,0,0,0.6)] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="px-6 py-4 border-b border-white/5 flex items-center justify-between">
          <h2 className="text-lg font-bold text-white flex items-center gap-2">
            <Building2 className="w-5 h-5 text-figaro-gold-base" />
            Nova Filial
          </h2>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-2.5 pl-10 pr-3 text-white placeholder-white/20 focus:outline-none focus:border-figaro-gold-base focus:ring-1 focus:ring-figaro-gold-base transition-all text-sm"
                  value={formData.name}
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg py-2.5 px-3 text-white placeholder-white/20 focus:outline-none focus:border-figaro-gold-base focus:ring-1 focus:ring-figaro-gold-base transition-all text-sm"
                ...
                <div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-lg py-2 pl-10 pr-3 text-white placeholder-white/20 focus:outline-none focus:border-figaro-gold-base focus:ring-1 focus:ring-figaro-gold-base transition-all text-sm"
          ...
          <div className="pt-4 flex gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-2.5 rounded-lg bg-figaro-gold-base text-black font-semibold hover:bg-figaro-gold-base hover:shadow-figaro-gold-base/30 transition-all text-sm disabled:opacity-50"
            >
