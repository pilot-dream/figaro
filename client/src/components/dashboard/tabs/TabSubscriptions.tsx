  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-end">
        ...
        <Button onClick={() => setIsCreatingPlan(true)} className="flex items-center gap-2 bg-[#11AFFA] hover:bg-[#11AFFA]/90 text-white font-medium border-none shadow-[0_0_15px_rgba(17,175,250,0.3)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GlassCard className="p-6 border-[#1A2332]/50 hover:border-[#11AFFA]/30 transition-all">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-[#11AFFA]/10 rounded-xl">
              <Users className="w-6 h-6 text-[#11AFFA]" />
            </div>
            <div>
            ...
            >
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  <span className="text-sm text-[#11AFFA] font-medium px-2 py-0.5 bg-[#11AFFA]/10 rounded-md">
                    {sub.planName}
                  </span>
          ...
          <GlassCard className="w-full max-w-md p-6 border-[#1A2332] shadow-2xl relative">
            ...
            <form className="space-y-4" onSubmit={async (e) => {
              ...
              <div>
                ...
                <input name="name" type="text" placeholder="Ex: VIP Mensal" required className="w-full bg-[#0A0E14] border border-[#1A2332] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#11AFFA] transition-colors" />
              </div>
              
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#8C97A8] mb-1">Preço Mensal (R$)</label>
                  <input name="price" type="number" min="0" step="0.01" placeholder="150.00" required className="w-full bg-[#0A0E14] border border-[#1A2332] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#11AFFA] transition-colors" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#8C97A8] mb-1">Cortes p/ Mês</label>
                  <input name="cutsPerPeriod" type="number" min="1" placeholder="4" required className="w-full bg-[#0A0E14] border border-[#1A2332] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#11AFFA] transition-colors" />
                </div>
              </div>

              <div>
                <label className="block text-sm font-medium text-[#8C97A8] mb-1">Descrição</label>
                <textarea name="description" rows={3} placeholder="Benefícios do plano..." className="w-full bg-[#0A0E14] border border-[#1A2332] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#11AFFA] transition-colors"></textarea>
              </div>

              <Button type="submit" disabled={isSubmitting} className="w-full bg-[#11AFFA] hover:bg-[#11AFFA]/90 text-white font-bold py-3 border-none shadow-[0_0_20px_rgba(17,175,250,0.3)] mt-2 disabled:opacity-50">
