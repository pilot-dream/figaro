  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button onClick={openNewModal} className="w-full sm:w-auto bg-[#11AFFA] hover:bg-[#0090FF] text-white">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {team.map((member) => (
            <GlassCard key={member.id} className="p-5 flex flex-col items-center text-center gap-4 border-white/10 hover:border-[#11AFFA]/40 transition-colors">
              ...
              <div>
                ...
                {member.specialty && (
                  <p className="text-xs font-medium text-[#11AFFA] mt-1">{member.specialty}</p>
                )}
            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-glass-border text-white text-sm focus:border-[#11AFFA] outline-none transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <label className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 border border-glass-border text-white text-sm hover:border-[#11AFFA] cursor-pointer transition-colors">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-glass-border text-white text-sm focus:border-[#11AFFA] outline-none appearance-none transition-colors"
                >
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${
                      commissionType === 'PERCENTAGE' 
                        ? 'bg-[#11AFFA] text-white shadow-md' 
              ...
              <div className="pt-4 border-t border-white/10">
                <Button type="submit" className="w-full bg-[#11AFFA] hover:bg-[#0090FF] text-white">
