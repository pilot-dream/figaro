...
export function ClientSheet({ appointment, onClose, onSaveNotes }: ClientSheetProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      <GlassCard className="w-full max-w-lg rounded-t-3xl sm:rounded-3xl p-6 space-y-6 border-amber-500/30 shadow-2xl animate-in slide-in-from-bottom duration-300">
        {/* Header */}
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full p-3 rounded-xl bg-white/5 border border-glass-border text-white text-xs focus:outline-none focus:border-amber-500 resize-none"
          />
        ...
        <div className="space-y-3 pt-2">
          <h4 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-1.5">
            <History className="w-4 h-4 text-amber-500" /> Histórico de Cortes
          </h4>
